...
contract sUDO is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 50000 * 10**9;
    ...
    constructor() ERC20("Staked UDO", "sUDO", 9) ERC20Permit() public {
    ...
    /**
        @notice increases sUDO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sUDO
